...
const SERVICES = [
  {
    ...
    items: [
      "Income Tax Services",
      "Company Registration asasass asaasass",
      "Sales Tax Services",
    ...
    detail: {
      ...
      description:
        "Our expert tax consultants provide end-to-end solutions for individuals and businesses. From filing income tax returns to registering your company, we handle all compliance so you can focus on growth.",
      highlights: [
  ...
  },
  {
    ...
    detail: {
      heading: "Accounting",
      description:
        "Accurate, timely, and transparent accounting services tailored to your business size and industry. We maintain your books meticulously so your financial picture is always crystal clear.",
      highlights: [
  ...
  },
  {
    ...
    items: [
      "Internal Audit",
      "External Audit",
      "Compliance Review and review and review",
      "Risk Assessment",
    ],
    detail: {
      heading: "Audit & Assurance",
      description:
        "Independent and objective audit services that give stakeholders confidence in your financial reporting. Our rigorous methodology identifies risks and strengthens internal controls.",
      highlights: [
  ...
  },
  {
    ...
    items: [
      "Business Strategy",
      "Financial Planning",
      "Investment Advisory and advisory advisory",
      "Growth Consulting",
    ],
    detail: {
      heading: "Business Advisory",
      description:
        "Strategic advisory services that help you navigate complex business decisions with clarity. We combine financial expertise with market intelligence to drive sustainable growth.",
      highlights: [
...
export default function Services() {
  ...
  return (
    <section className="bg-light py-20 px-6 md:px-12 lg:px-24">
          ...
          return (
            ...
            <button
             data-aos-delay={svc.aosDelay}
              ...
              className={`group text-left rounded-2xl border transition-all duration-300 overflow-hidden focus:outline-none ${isActive
            ...
            >
              ...
              <div
                className={`p-5  transition-colors duration-300 ${isActive ? "bg-white" : "bg-[#f9fafb] group-hover:bg-white"
                  }`}
              >
      ...
      {/* Detail panel — loads below on card click */}
      <div
        className={`max-w-6xl mx-auto transition-all duration-500 overflow-hidden ${activeService
      ...
      >
        {activeService && (
          <div
            ...
            style={{ borderColor: activeService.lightBg }}
          >
            {/* Panel header strip */}
            <div
              className={`bg-gradient-to-r ${activeService.color} px-8 py-4 flex items-center justify-between`}
            >
            ...
            <div
              ...
              style={{ background: activeService.lightBg }}
            >
              {/* Description */}
              ...
              <div className="flex flex-col gap-4">
                {activeService.detail.highlights.map((h) => (
                  <div
                    key={h.label}
